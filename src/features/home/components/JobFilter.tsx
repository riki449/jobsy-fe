...
import { FormSelect, SelectOption } from "@/src/components/common/FormSelect";
import { Area, JobCategoryGroup, JobListBodyRequest } from "@/src/features/jobs/types";
    ...
    (categoryData &&
      categoryData.map((group: JobCategoryGroup) => ({
        ...
        options: group.categories.map((cat) => ({
          ...
          value: cat.slug, // Sử dụng slug hoặc ID tùy API
        })),
      }))) ||
    [];
